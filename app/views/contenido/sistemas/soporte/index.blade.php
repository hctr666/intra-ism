...
<head>
<meta charset="UTF-8">
<title>Soporte de Sistemas</title>
...
<body>
    @include('contenido.sistemas.soporte.header')
    <div style="margin:18px;margin-top:66px;">
        {{ HTML::style('assets/css/bs/3.3.4/bootstrap.min.css'); }}
        @include('contenido.sistemas.soporte.content')
    </div>
</body>
</html>
...
{{ HTML::script('assets/js/util/Documento.js'); }}
